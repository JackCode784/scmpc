# 1 "MPCwithMADS_fxd/pseudoRand.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MPCwithMADS_fxd/pseudoRand.cpp" 2
...
# 2 "MPCwithMADS_fxd/pseudoRand.cpp" 2
...
using std::tgamma;
using std::trunc;
# 3 "MPCwithMADS_fxd/pseudoRand.cpp" 2
...
void pseudoRand(data_rand randomVector[2]) {
 ...
 ap_uint<21> m = 1048576;
  ...
  R2shift = R2;
  v[1] = (R2shift >> 19) - 1;
# 42 "MPCwithMADS_fxd/pseudoRand.cpp"
 VITIS_LOOP_42_1: for (int i = 0; i < 2; i++) {
  randomVector[i] = v[i];
 }
