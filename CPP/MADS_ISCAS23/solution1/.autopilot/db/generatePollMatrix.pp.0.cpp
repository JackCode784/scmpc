# 1 "MPCwithMADS_fxd/generatePollMatrix.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MPCwithMADS_fxd/generatePollMatrix.cpp" 2
...
void MPCwithMADS(data_in x[2], data_in par[2], data_in ref[1], data_out uOpt[1]);
...
# 2 "MPCwithMADS_fxd/generatePollMatrix.cpp" 2
...
using std::tgamma;
using std::trunc;
# 3 "MPCwithMADS_fxd/generatePollMatrix.cpp" 2

void generatePollMatrix(data_u currentPoint[2], data_meshExp frameIdx[2], data_meshExp meshIdx[2], data_u pollMatrix[2][2 * 2])
{

 data_u currentPoint_int[2];


 data_meshSize mesh[2];


 data_dir directions[2][2 * 2];


 data_rand randomVector[2];


 VITIS_LOOP_19_1: for (int i = 0; i < 2; i++) {
 ...
 VITIS_LOOP_44_2: for (int i = 0; i < 2; i++) {
  VITIS_LOOP_45_3: for (int j = 0; j < 2 * 2; j++) {
