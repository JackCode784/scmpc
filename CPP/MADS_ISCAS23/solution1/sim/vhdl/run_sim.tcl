...
if {[file isfile MPCwithMADS.autotvin.dat]} {
	file delete -force MPCwithMADS.autotvin.dat
}

if {[file isfile MPCwithMADS.autotvout.dat]} {
	file delete -force MPCwithMADS.autotvout.dat
}
