...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.MPCwithMADS.autotvin_x_0.dat"
         "c.MPCwithMADS.autotvin_x_1.dat"
         "c.MPCwithMADS.autotvin_par_0.dat"
         "c.MPCwithMADS.autotvin_par_1.dat"
         "c.MPCwithMADS.autotvin_ref.dat"
         "c.MPCwithMADS.autotvout_uOpt.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.MPCwithMADS.autotvout_uOpt.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
