...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "MPCwithMADS.autotvin.dat"
	set constFileTvOut       "MPCwithMADS.autotvout.dat"
	set constFileHdlTvIn     "MPCwithMADS.autohdltvin.dat"
	set constFileHdlTvOut    "MPCwithMADS.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
